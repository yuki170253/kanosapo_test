...
struct MainBarEntry {
    ...
    var curvedSegments: [CurvedSegmentForBar] {
        ...
        let segment1 = CurvedSegmentForBar(startPoint: startPoint, endPoint: endPoint, toPoint: toPoint, controlPoint1: controlPoint1, controlPoint2: controlPoint2)
        ...
        let segment2 = CurvedSegmentForBar(startPoint: startPoint, endPoint: endPoint, toPoint: toPoint, controlPoint1: controlPoint1, controlPoint2: controlPoint2)
...
struct TopBubbleEntry {
    ...
    var curvedSegments: [CurvedSegmentForBar] {
        ...
        controlPoint1 = CGPoint(x: origin.x, y: origin.y + curvedValue)
        controlPoint2 = CGPoint(x: origin.x + topBubbleRadius - curvedValue, y: origin.y + topBubbleRadius)
        let segment3 = CurvedSegmentForBar(startPoint: startPoint, endPoint: endPoint, toPoint: toPoint, controlPoint1: controlPoint1, controlPoint2: controlPoint2)
        ...
        controlPoint2 = CGPoint(x: origin.x + topBubbleRadius + curvedValue, y: origin.y + topBubbleRadius)
        let segment4 = CurvedSegmentForBar(startPoint: startPoint, endPoint: endPoint, toPoint: toPoint, controlPoint1: controlPoint1, controlPoint2: controlPoint2)
