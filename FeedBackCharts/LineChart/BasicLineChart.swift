...
//  MyTodoList
//
//  Created by yanagimachi_riku on 2019/11/30.
...
class BasicLineChart: UIView {
    ...
    private func setupView() {
        ...
        self.backgroundColor = #colorLiteral(red: 0.9068536968, green: 0.6582231034, blue: 0.8840557582, alpha: 1)
    }
    ...
    private func drawLables() {
        if let dataEntries = dataEntries,
            ...
            for i in 0..<dataEntries.count {
                ...
                textLayer.foregroundColor = #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1).cgColor
    ...
    private func drawHorizontalLines() {
        ...
        if let gridValues = gridValues {
            for value in gridValues {
                ...
                lineLayer.path = path.cgPath
                lineLayer.fillColor = UIColor.clear.cgColor
                lineLayer.strokeColor = #colorLiteral(red: 0.2594356344, green: 0.2537919574, blue: 0.2705742659, alpha: 1).cgColor
