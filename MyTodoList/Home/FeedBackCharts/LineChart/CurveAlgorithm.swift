...
class CurveAlgorithm {
    ...
    private func controlPointsFrom(points: [CGPoint]) -> [CurvedSegmentForLine] {
        var result: [CurvedSegmentForLine] = []
        ...
        for i in 1..<points.count {
            ...
            let curvedSegment = CurvedSegmentForLine(controlPoint1: controlPoint1, controlPoint2: controlPoint2)
    ...
    func createCurvedPath(_ dataPoints: [CGPoint]) -> UIBezierPath? {
        ...
        var curveSegments: [CurvedSegmentForLine] = []
